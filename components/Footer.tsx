...
export function Footer() {
  ...
  return (
    <footer className="bg-bg-panel border-t border-border mt-14">
      <div className="max-w-[1280px] mx-auto px-4 sm:px-6 py-11 grid grid-cols-2 lg:grid-cols-[1.4fr,1fr,1fr,1fr] gap-8 lg:gap-10">
        {/* Marque */}
      ...
      <div className="border-t border-border">
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6 py-5 flex flex-col sm:flex-row justify-between items-center gap-3 text-[11.5px] text-ink-faint">
