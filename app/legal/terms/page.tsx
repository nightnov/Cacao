  ...
  return (
    <main className="min-h-screen bg-[#FBF6EE] flex flex-col">
      ...
      <div className="flex-1 max-w-4xl mx-auto px-10 py-16 w-full">
        ...
        <div className="prose prose-sm max-w-none space-y-6 text-[#56534C]">
          <div>
            <h2 className="font-serif font-semibold text-2xl text-[#1A1A1A] mb-3">1. Acceptation des conditions</h2>
            <p>
          ...
          <div>
            <h2 className="font-serif font-semibold text-2xl text-[#1A1A1A] mb-3">2. Utilisation de la plateforme</h2>
            <p>
              Vous vous engagez à :
            </p>
          ...
          <div>
            <h2 className="font-serif font-semibold text-2xl text-[#1A1A1A] mb-3">3. Produits et prix</h2>
            <p>
          ...
          <div>
            <h2 className="font-serif font-semibold text-2xl text-[#1A1A1A] mb-3">4. Processus de commande</h2>
            <p>
          ...
          <div>
            <h2 className="font-serif font-semibold text-2xl text-[#1A1A1A] mb-3">5. Paiement</h2>
            <p>
          ...
          <div>
            <h2 className="font-serif font-semibold text-2xl text-[#1A1A1A] mb-3">6. Livraison</h2>
            <p>
          ...
          <div>
            <h2 className="font-serif font-semibold text-2xl text-[#1A1A1A] mb-3">7. Retours et remboursements</h2>
            <p>
          ...
          <div>
            <h2 className="font-serif font-semibold text-2xl text-[#1A1A1A] mb-3">8. Limite de responsabilité</h2>
            <p>
          ...
          <div>
            <h2 className="font-serif font-semibold text-2xl text-[#1A1A1A] mb-3">9. Propriété intellectuelle</h2>
            <p>
          ...
          <div>
            <h2 className="font-serif font-semibold text-2xl text-[#1A1A1A] mb-3">10. Modifications</h2>
            <p>
          ...
          <div className="pt-6 border-t border-[#E4DDCF]">
            <p className="text-sm">
