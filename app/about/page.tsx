    ...
    <main className="min-h-screen bg-[#1C2021] flex flex-col">
      ...
      <div className="flex-1 max-w-4xl mx-auto px-5 sm:px-10 py-16 w-full">
        ...
        <div className="prose prose-sm max-w-none">
          <p className="text-[#B3B8BE] leading-relaxed mb-6">
          ...
          <h2 className="font-serif font-semibold text-2xl text-[#EEF2F7] mt-8 mb-4">Notre mission</h2>
          <p className="text-[#B3B8BE] leading-relaxed mb-6">
          ...
          <h2 className="font-serif font-semibold text-2xl text-[#EEF2F7] mt-8 mb-4">Nos valeurs</h2>
          <ul className="text-[#B3B8BE] leading-relaxed mb-6 list-disc list-inside space-y-2">
          ...
          <h2 className="font-serif font-semibold text-2xl text-[#EEF2F7] mt-8 mb-4">Paiements sécurisés</h2>
          <p className="text-[#B3B8BE] leading-relaxed mb-6">
          ...
          <h2 className="font-serif font-semibold text-2xl text-[#EEF2F7] mt-8 mb-4">Livraison</h2>
          <p className="text-[#B3B8BE] leading-relaxed">
