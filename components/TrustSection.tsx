...
export function TrustSection() {
  return (
    <section className="bg-[#1C2021] border-t border-b border-[#35383C]">
      <div className="max-w-7xl mx-auto px-5 sm:px-10 py-7 grid grid-cols-3 gap-6">
        <div className="text-center">
          ...
          <small className="text-xs text-[#8E959D] underline decoration-dotted">Partout à Abidjan</small>
        </div>
        ...
        <div className="text-center">
          ...
          <small className="text-xs text-[#8E959D] underline decoration-dotted">Sur chaque appareil</small>
        </div>
        ...
        <div className="text-center">
          ...
          <small className="text-xs text-[#8E959D] underline decoration-dotted">Via MoneyFusion</small>
        </div>
      </div>
    </section>
  )
