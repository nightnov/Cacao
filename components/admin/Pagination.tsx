    ...
    <div className="flex flex-col sm:flex-row items-center justify-between gap-3 px-6 py-4 border-t border-border">
      ...
      <div className="flex items-center gap-1">
        <button
          ...
          disabled={page === 1}
          className="p-2 rounded-lg text-ink-dim hover:bg-bg-raised disabled:opacity-30 disabled:hover:bg-transparent"
        ...
        {pages.map(p => (
          <button
            ...
            className={`w-8 h-8 rounded-lg text-sm font-semibold transition-colors ${
              p === page ? 'bg-gold text-ink-invert' : 'text-ink-dim hover:bg-bg-raised'
            }`}
          >
            {p}
          </button>
