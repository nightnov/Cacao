    ...
    <main className="min-h-screen bg-[#1C2021] flex flex-col">
      ...
      <div className="flex-1 max-w-4xl mx-auto px-5 sm:px-10 py-16 w-full">
        ...
        <div className="prose prose-sm max-w-none space-y-6 text-[#B3B8BE]">
          <div>
            <h2 className="font-serif font-semibold text-2xl text-[#EEF2F7] mb-3">1. Données collectées</h2>
            <p>
          ...
          <div>
            <h2 className="font-serif font-semibold text-2xl text-[#EEF2F7] mb-3">2. Utilisation de vos données</h2>
            <p>
          ...
          <div>
            <h2 className="font-serif font-semibold text-2xl text-[#EEF2F7] mb-3">3. Protection de vos données</h2>
            <p>
          ...
          <div>
            <h2 className="font-serif font-semibold text-2xl text-[#EEF2F7] mb-3">4. Partage de données</h2>
            <p>
          ...
          <div>
            <h2 className="font-serif font-semibold text-2xl text-[#EEF2F7] mb-3">5. Vos droits</h2>
            <p>
          ...
          <div>
            <h2 className="font-serif font-semibold text-2xl text-[#EEF2F7] mb-3">6. Cookies</h2>
            <p>
          ...
          <div>
            <h2 className="font-serif font-semibold text-2xl text-[#EEF2F7] mb-3">7. Modifications</h2>
            <p>
